...
const UpdateUpcomingCamp = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await axiosSecure.patch(`/update-upcoming-camp/${camp._id}`, updatedCamp);
        ...
        if (res.data.modifiedCount > 0) {
            ...
            Swal.fire({
                position: "top-end",
                icon: "success",
                title: `Upcoming Campaign updated successfully`,
    ...
    return (
        <div className="border shadow-lg mx-5 rounded-xl text-center min-h-screen ">
            <Helmet>
                <title>MediCamp | Update Upcoming Camp</title>
            </Helmet>
            <Heading
                heading={"Update Upcoming Campaign"}
            />
